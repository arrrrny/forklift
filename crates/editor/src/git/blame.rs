...
mod tests {
    ...
    async fn test_blame_error_notifications(cx: &mut gpui::TestAppContext) {
        ...
        let blame = cx
            .new_model(|model, cx| GitBlame::new(buffer.clone(), project.clone(), true, true, model, cx));
    ...
    async fn test_blame_for_rows(cx: &mut gpui::TestAppContext) {
        ...
        let git_blame =
            cx.new_model(|model, cx| GitBlame::new(buffer.clone(), project, false, true, model, cx));
