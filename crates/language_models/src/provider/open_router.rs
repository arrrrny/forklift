...
use open_router::{Model, ResponseStreamEvent, stream_completion};
...
impl LanguageModelProvider for OpenRouterLanguageModelProvider {
    ...
    fn provided_models(&self, cx: &App) -> Vec<Arc<dyn LanguageModel>> {
        ...
        // Add base models from open_router::Model::iter()
        for model in open_router::Model::iter() {
            if !matches!(model, open_router::Model::Custom { .. }) {
                ...
                .child(
                    List::new()
                        .child(InstructionListItem::new(
                            ...
                            Some("https://platform.openrouter.com/api-keys"),
                        ))
